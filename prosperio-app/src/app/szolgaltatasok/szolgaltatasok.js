    ...
    <div id="services" className="section relative pt-20 pb-8 md:pt-16 md:pb-0 bg-white">
      <div className="container xl:max-w-6xl mx-auto px-4">
        <header className="text-center mx-auto mb-12 lg:px-20">
          <h2 className="text-2xl leading-normal mb-2 font-bold text-mediumBlue">Szolgáltatásaink</h2>
          <svg
            version="1.1"
            ...
            <div className="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
              <div className="inline-block text-gray-900 mb-4">
                ...
                >
                  ...
                  <path d="M14 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h12zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h1.5a2 2 0 0 0 1.6-.8L8 10.667l2.9 3.533a2 2 0 0 0 1.6.8H14a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z" />
                </svg>
              </div>
